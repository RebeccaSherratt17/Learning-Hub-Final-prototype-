...
export default function VideoForm({
  ...
  const [ogImageAlt, setOgImageAlt] = useState(video?.ogImageAlt ?? '')
      ...
      <div className="bg-white rounded-lg shadow-sm p-6 space-y-4">
        ...
        <div>
          <label htmlFor="vidyardUrl" className="block text-sm font-medium text-diligent-gray-5 mb-1">
            Vidyard URL/ID <span className="text-diligent-red">*</span>
          </label>
          <input
            id="vidyardUrl"
            type="text"
        ...
        <div>
          <label htmlFor="duration" className="block text-sm font-medium text-diligent-gray-5 mb-1">
            Duration <span className="text-diligent-red">*</span>
          </label>
          <input
            id="duration"
            type="text"
