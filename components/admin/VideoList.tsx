          ...
          <tbody>
            {loading ? (
              ...
              sortedVideos.map((video) => (
                <tr key={video.id} className="border-b border-diligent-gray-1 hover:bg-diligent-gray-1/50">
                  ...
                  <td className="px-4 py-3">
                    <span className={`inline-block rounded-full px-2 py-0.5 text-xs font-medium ${tierStyles[video.accessTier]}`}>
                      {tierLabels[video.accessTier]}
                    </span>
                  </td>
